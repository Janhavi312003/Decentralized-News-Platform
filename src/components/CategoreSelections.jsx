...
const CategoreSelections = ({onSelectCategory, activeCategory}) => {
    const categories = ["World","India","Business","Polities","Health","Sports","Technology","Entertainment"];
...
export default CategoreSelections
